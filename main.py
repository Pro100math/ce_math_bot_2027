...
async def cmd_start(message: types.Message, state: FSMContext):
    ...
    builder.button(text="📚 Сборник 2024 г.", callback_data="year_2024")
    builder.button(text="📚 Сборник 2025 г.", callback_data="year_2025")
    builder.button(text="📚 Сборник 2026 г.", callback_data="year_2026")
    builder.adjust(2)
